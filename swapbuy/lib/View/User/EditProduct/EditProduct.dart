    ...
    return Consumer<EditProductController>(
      builder:
          (context, controller, child) => Scaffold(
            appBar: AppBar(centerTitle: true, title: Text("Edit Product")),
            ...
            body: ListView(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ButtonCustom(
                      ...
                      bordersize: .5,
                      child:
                          controller.urlpicture != null
                              ? ClipRRect(
                                borderRadius: BorderRadius.circular(15),
                                child: FadeInImage.assetNetwork(
                                  placeholder: "assets/PNG/Logo.png",
                                  image: "${controller.urlpicture}",
                                  fit: BoxFit.fill,
                                ),
                              )
                ...
                DropdownCustom<Address>(
                  ...
                  items:
                      controller.adresses.map((e) {
                        final isLast = e == controller.adresses.last;
                ...
                Padding(
                  ...
                  child: ButtonCustom(
                    onTap: () async {
                      ...
                      EasyLoading.show();
                      try {
                        final res = await controller.EditProduct(context);
                        res.fold(
                          (l) {
