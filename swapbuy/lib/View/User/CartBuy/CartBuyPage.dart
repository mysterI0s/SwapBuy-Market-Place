...
class CartBuyPage extends StatelessWidget {
  const CartBuyPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<CartBuyPageController>(
      builder:
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: FadeInImage.assetNetwork(
                                  ...
                                  image:
                                      "${controller.productFull!.product!.image}",
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  "Product: ${controller.productFull!.product!.name!}",
                                ...
                                Text(
                                  "Owner: ${"${controller.productFull!.buyer?.user?.name! ?? "Unkown"}"}",
